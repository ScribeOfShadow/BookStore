...
namespace BookStore.Controllers
{
    ...
    public class ShoppingCartController : Controller
    {
        ...
        // GET: ShoppingCart
        public ActionResult Index(UsedCouponList usedCouponList)
        {
            ...
            var ValidCoupon = dB.UsedCouponLists.Where(x => x.CouponUserIsValid == true && x.CouponDiscountAmount != null).ToList();
            foreach (var discount in ValidCoupon) 
            { 
               
                if(discount.CouponUserIsValid == true)
                {
                    ViewBag.TotalCost = cart.GetTotal()-(cart.GetTotal() * discount.CouponDiscountAmount) / 100 + cart.GetDeliveryFee() ;
